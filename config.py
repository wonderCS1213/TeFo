...
class cfg():
    ...
    def get_args(self):
        ...
        parser.add_argument("--model_name", default="TeFo", type=str, choices=["EVA", "MCLEA", "MSNEA", "TeFo"], help="model name")
        ...
        # --------- TeFo -----------
        parser.add_argument("--hidden_size", type=int, default=100, help="the hidden size of TeFo")
        parser.add_argument("--intermediate_size", type=int, default=400, help="the hidden size of TeFo")
        parser.add_argument("--num_attention_heads", type=int, default=5, help="the number of attention_heads of TeFo")
        parser.add_argument("--num_hidden_layers", type=int, default=2, help="the number of hidden_layers of TeFo")
        ...
        parser.add_argument("--use_adv", type=bool, default=True, help="Use adversarial modality discriminator")
        parser.add_argument("--alpha_adv", type=float, default=12, help="Weight of adversarial modality loss")
